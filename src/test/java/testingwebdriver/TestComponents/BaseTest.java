package testingwebdriver.TestComponents;
...
public class BaseTest {
	...
	public WebDriver initializeDriver() throws IOException {
        ...
        FileInputStream fis = new FileInputStream(System.getProperty("user.dir")+"//src//main//java//TestingWebDriver//resources//GlobalData.properties");
        prop.load(fis);
